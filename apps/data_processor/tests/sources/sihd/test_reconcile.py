...
def _row(
    ...
    return {
        ...
        "NUM_AIHS": [aih], "aih_count": 1, "procedimento_qtd": qtd, "valor_centavos": valor,
...
_EXPECTED_ROWS = [
    _row(("0765432", "0303010037"), "3526100000099", (1, 1000), None),
    _row(("1234567", "0303010037"), "3526100000011", (1, 15025), _AIH1),
    _row(("1234567", "0303140151"), "3526100000033", (3, 10000), _AIH3),
    _row(("1234567", "04110100"), "3526100000022", (1, 2010), _AIH2),
    _row(("1234567", "0411010034"), "3526100000022", (1, 48000), _AIH2),
    _row(("1234567", "0802010083"), "3526100000011", (3, 268), _AIH1),
]
_EXPECTED_DIVERGENCES = [
    ("cnes_divergente", "3526100000033|0303140151|2026-01|3.1", "CNES", "1234567|0765432",
     _PROCEDIMENTOS),
    ("cnes_divergente", "3526100000033|0303140151|2026-01|3.2", "CNES", "1234567|0765432",
     _PROCEDIMENTOS),
    ("internacao_sem_proc", "3526100000044|0303010037|2026-01|4", "NUM_AIH", "3526100000044",
     _INTERNACOES),
    ("proc_sem_internacao", "3526100000099|0303010037|2026-01|9.1", "NUM_AIH", "3526100000099",
     _PROCEDIMENTOS),
    ("quality:campo_obrigatorio_ausente", "3526100000033|0303140151|2026-01|3.2", "VALOR", None,
     _QUALITY_PROC),
    ("quality:codigo_desconhecido", "3526100000022|0411010034|2026-01|2", "SITUACAO", "7",
     _QUALITY_INTERNACAO),
    ("quality:codigo_desconhecido", "3526100000022|04110100|2026-01|2.2", "PROCEDIMENTO",
     "04110100", _QUALITY_PROC),
    ("quality:data_invalida", "3526100000044|0303010037|2026-01|4", "DT_SAIDA", "20260231",
     _QUALITY_INTERNACAO),
]

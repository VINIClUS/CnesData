...
PII_DENY_LIST: Final[frozenset[str]] = frozenset({
    ...
    "AH_PACIENTE_TEL_DDD", "AH_PACIENTE_TEL_NUM", "AH_MED_SOL_DOC", "AH_MED_RESP_DOC",
    "PA_PF_DOC", "PACIENTE_NOME", "PACIENTE_CNS", "PACIENTE_DT_NASCIMENTO",
    "MED_SOL_DOC", "MED_RESP_DOC", "DOC_EXEC", "paciente_nome", "paciente_cns", "cpf",
    "data_nascimento",
})

...
PII_DENY_LIST: Final[frozenset[str]] = frozenset({
    ...
    "AH_PACIENTE_LOGR_CEP", "AH_PACIENTE_LOGR_COMPL", "AH_PACIENTE_LOGR_NUMERO",
    "AH_PACIENTE_LOGR_UF", "AH_PACIENTE_TIPO_LOGR", "AH_PACIENTE_TEL_DDD",
    "AH_PACIENTE_TEL_NUM", "AH_PRONTUARIO", "AH_MED_SOL_DOC", "AH_MED_RESP_DOC",
    "AH_AUTORIZADOR_DOC", "AH_DIR_CLINICO_DOC", "AH_GESTOR_DOC", "AH_ACDTRAB_CNPJ_EMP",
    "PA_PF_DOC", "PA_CREDITO_DOC", "PA_PJ_DOC", "PACIENTE_NOME", "PACIENTE_CNS",
    "PACIENTE_DT_NASCIMENTO", "MED_SOL_DOC", "MED_RESP_DOC", "DOC_EXEC",

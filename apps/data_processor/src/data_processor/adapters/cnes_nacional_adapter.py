...
class CnesNacionalAdapter:
    """Adapter entre BigQuery (basedosdados) e schema canonico."""
    ...
    def listar_estabelecimentos(
        ...
        Args:
            competencia: (ano, mes) obrigatorio.
        ...
        return self._ler_ou_cachear(
            chave,
            lambda: self._buscar_estabelecimentos(ano, mes),
        )
    ...
    def listar_profissionais(
        ...
        """Retorna vinculos nacionais (FONTE=NACIONAL).
        ...
        return self._ler_ou_cachear(
            chave,
            lambda: self._buscar_profissionais(ano, mes),
        )

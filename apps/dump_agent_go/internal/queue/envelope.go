...
// SHA256 + MinioKey + FatoSubtype are set for TypeComplete (FU1
// RegisterJob dispatch) so drain replay after agent restart can rebuild
// the full Job payload - FatoSubtype is required by FileManifest server-side.
type Envelope struct {
	...
	FatoSubtype    string          `json:"fato_subtype,omitempty"`

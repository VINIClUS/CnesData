...
@patch("dump_agent.stages.ingestao_local.conectar")
@patch("dump_agent.stages.ingestao_local.extrair_lookup_cbo")
@patch("dump_agent.stages.ingestao_local.CnesLocalAdapter")
@patch("dump_agent.stages.ingestao_local.ProfissionalContract")
@patch("dump_agent.stages.ingestao_local.EstabelecimentoContract")
...
def test_early_return_quando_target_source_nacional():
    ...
    with patch("dump_agent.stages.ingestao_local.conectar") as mock_con:
        IngestaoLocalStage().execute(state)

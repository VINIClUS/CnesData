...
- Start after the runtime-amendments plan is merged and green; infrastructure planning also requires CND-020…025 integrated. CND-020…025 are satisfied (#122-#127, closed 2026-09-01..2026-09-06).
- Runtime promotion remains blocked until AWS-010…014 and serial acceptance are green. AWS-010…014 are entirely unimplemented today and are gated behind EPIC #94's controller Task 8, which queues behind CND-064 (#222 / PR #227, in flight).
...
- Schema/index definitions are generated from the merged DynamoDB adapter access-pattern contract (cnes_infra.control_plane.dynamodb_keys, dynamodb_queries and dynamodb_publication); no convenience GSI is invented.

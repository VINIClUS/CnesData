...
def df_profissionais_bruto() -> pd.DataFrame:
    ...
    return pd.DataFrame({
        ...
        "COD_VINCULO":        ["010101", "010101", "010500"],
        "SUS_NAO_SUS":        ["S", "S", "S"],
        "CARGA_HORARIA_TOTAL": [40, 40, 40],
        ...
        "COD_TIPO_UNIDADE":   ["02", "02", "02"],
        "COD_MUN_GESTOR":     ["354130", "354130", "354130"],
        "COD_INE_EQUIPE":     [None, None, None],
        "NOME_EQUIPE":        [None, None, None],
        "COD_TIPO_EQUIPE":    [None, None, None],
    })
...
def df_com_cpf_invalido() -> pd.DataFrame:
    ...
    return pd.DataFrame({
        ...
        "CH_OUTRAS":          [0, 0, 0],
        "CH_HOSPITALAR":      [0, 0, 0],
        "COD_CNES":           ["0985333", "0985334", "0985335"],
        "ESTABELECIMENTO":    ["UBS A", "UBS B", "UBS C"],
        "COD_TIPO_UNIDADE":   ["01", "02", "02"],
        "COD_MUN_GESTOR":     ["354130", "354130", "354130"],
        "COD_INE_EQUIPE":     [None, None, None],
        "NOME_EQUIPE":        [None, None, None],
        "COD_TIPO_EQUIPE":    [None, None, None],
...
def df_com_carga_horaria_zero() -> pd.DataFrame:
    ...
    return pd.DataFrame({
        ...
        "CBO":                ["515105", "515105"],
        "COD_VINCULO":        ["010101", "010101"],
        "SUS_NAO_SUS":        ["S", "S"],
        "CARGA_HORARIA_TOTAL": [0, 40],
        "CH_AMBULATORIAL":    [0, 40],
        "CH_OUTRAS":          [0, 0],
        "CH_HOSPITALAR":      [0, 0],
        "COD_CNES":           ["0985333", "0985333"],
        "ESTABELECIMENTO":    ["UBS A", "UBS A"],
        "COD_TIPO_UNIDADE":   ["01", "01"],
        "COD_MUN_GESTOR":     ["354130", "354130"],
        "COD_INE_EQUIPE":     [None, None],
        "NOME_EQUIPE":        [None, None],
        "COD_TIPO_EQUIPE":    [None, None],
    })

"""Testes adicionais do HistoricoReader — glosas, métricas avançadas e tabelas Gold."""
...
def _criar_tabelas_extras(con) -> None:
    con.execute("""
...
# ── TestNovosMetodosHistoricoReader ───────────────────────────────────────────
